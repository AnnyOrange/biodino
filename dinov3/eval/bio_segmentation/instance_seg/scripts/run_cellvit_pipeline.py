...
Loops datasets × checkpoint-iterations × {frozen, finetune} and invokes
...
def main():
    ...
    p.add_argument("--modes", nargs="+", default=["frozen"], choices=["frozen", "finetune"])
        ...
        for dataset in args.datasets:
            ...
            for mode in args.modes:
                ...
                cmd = [
                    ...
                    ("--finetune" if mode == "finetune" else "--freeze-backbone"),
                ]
