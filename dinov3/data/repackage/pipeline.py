...
def _encode_sample(
    *,
    ...
    out_meta: Dict[str, Any] = {
        ...
        "dataset_id_original": meta.get("dataset_id_original", ""),
        "source_pool": meta.get("source_pool", ""),
        "sampling_strategy": meta.get("sampling_strategy", ""),
        "group_key": meta.get("group_key", ""),
        "method_label": meta.get("method_label", ""),
        "organism_label": meta.get("organism_label", ""),
        "plan_target_patches": meta.get("plan_target_patches"),
